...
class RealtimePlotApp(ctk.CTk):
    ...
    def export_data_to_csv(self):
        ...
        # 把 fft_info 資料放在最前面，然後再把原始數據加到後面
        ...
        if file_path:
            ...
            final_df.to_csv(file_path, index=False, encoding='utf-8-sig')  # 使用 utf-8-sig 編碼
